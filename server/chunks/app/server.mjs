import { hasInjectionContext, getCurrentInstance, version, ref, defineAsyncComponent, defineComponent, h, inject, onUnmounted, watchEffect, watch, computed, Fragment, useSSRContext, createApp, reactive, unref, toRef, isRef, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, Text, effectScope, markRaw, isShallow, isReactive, toRaw, withCtx, nextTick, Suspense, Transition } from 'vue';
...
const LazySvgoBackground = defineAsyncComponent(() => import('./_nuxt/background-0847f7f8.mjs').then((r) => r.default));
const LazySvgoEmptyImage = defineAsyncComponent(() => import('./_nuxt/empty-image-cb94229b.mjs').then((r) => r.default));
const LazySvgoGameScheduleBackground = defineAsyncComponent(() => import('./_nuxt/game-schedule-background-66901f99.mjs').then((r) => r.default));
const LazySvgoPhoto = defineAsyncComponent(() => import('./_nuxt/photo-05131ef1.mjs').then((r) => r.default));
const LazySvgoPlus = defineAsyncComponent(() => import('./_nuxt/plus-169d7e85.mjs').then((r) => r.default));
const lazyGlobalComponents = [
  ["SvgoBackground", LazySvgoBackground],
  ["SvgoEmptyImage", LazySvgoEmptyImage],
  ["SvgoGameScheduleBackground", LazySvgoGameScheduleBackground],
...
const _routes = [
  {
    name: "archive-id___ru",
    path: "/archive/:id()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-5760678f.mjs').then((m) => m.default || m)
  },
  {
    name: "archive___ru",
    path: "/archive",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-87463ccb.mjs').then((m) => m.default || m)
  },
  {
    name: "auth___ru",
    path: "/auth",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/auth-2551af53.mjs').then((m) => m.default || m)
  },
  {
    name: "games-id___ru",
    path: "/games/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-b39b32f2.mjs').then((m) => m.default || m)
  },
  {
    name: "games___ru",
    path: "/games",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-cd15654e.mjs').then((m) => m.default || m)
  },
  {
    name: "games-schedule___ru",
    path: "/games/schedule",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/schedule-6dca1053.mjs').then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-e4896cde.mjs').then((m) => m.default || m)
  },
  {
    name: "profile___ru",
    path: "/profile",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/profile-5d988de7.mjs').then((m) => m.default || m)
  }
];
...
const localeCodes = ["ru"];
const localeMessages = {
  "ru": [{ key: "../i18n/locales/ru.js", load: () => Promise.resolve(locale_ru) }]
};
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  nuxtI18nOptions.locales = [Object({ "code": "ru", "file": "ru.js", "hash": "f1cfcb7d", "type": "static" })];
  ...
  nuxtI18nOptions.langDir = "i18n/locales";
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "ru", "file": "ru.js", "hash": "f1cfcb7d", "type": "static" })] });
...
const layouts = {
  default: () => import('./_nuxt/default-09eb4ce9.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-6e7cdb7b.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-da9f9fe1.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useStrapiAuth as a, useCookie as b, createError as c, useStrapiClient as d, entry$1 as default, useStrapiVersion as e, useHead as f, useRouter as g, navigateTo as n, useNuxtApp as u };
